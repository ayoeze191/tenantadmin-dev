<template>
    <div class="bg-neutral py-5 px-10 w-full overflow-y-scroll h-screen pb-40">
      <section class="list_container mt-10">
         ...
         <p class="text-black w-fit mx-auto">   No pending service request has been made yet</p>
        </div>
      </section>
    </div>
  ...
  export default {
      ...
      methods: {
        ...
        if (response.responseCode == '00') {
          this.pending_request = response.serviceRequests.filter((req) =>  req.service.serviceStatus == 1);
