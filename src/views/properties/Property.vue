                ...
                >
                  <a-tab-pane :key="1" tab="Property Info">
                    ...
                    <div class="mt-[26px]">
                      ...
                      <a :href="propertyInfo.propertyDoc" class="bg-[#FAFAFA] p-4 w-fit rounded-[4px] mt-2 flex flex-col gap-2 items-center">
                        <svg width="44" height="48" viewBox="0 0 44 48" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M34 0L42 8V46C42 47.1046 41.1046 48 40 48H4C2.89543 48 2 47.1046 2 46V2C2 0.895431 2.89543 1.61064e-08 4 0H34Z" fill="#E4E7EC"/>
<path d="M42 8H34V0L42 8Z" fill="#98A2B3"/>
<rect y="20" width="44" height="20" rx="2" fill="#CC400C"/>
<path d="M7.32812 35.8161V24.1797H11.6918C12.5857 24.1797 13.3357 24.3464 13.9418 24.6797C14.5516 25.013 15.0118 25.4714 15.3224 26.0547C15.6368 26.6342 15.794 27.2933 15.794 28.032C15.794 28.7782 15.6368 29.4411 15.3224 30.0206C15.008 30.6001 14.544 31.0566 13.9304 31.3899C13.3168 31.7195 12.5611 31.8842 11.6634 31.8842H8.77131V30.1513H11.3793C11.902 30.1513 12.33 30.0604 12.6634 29.8786C12.9967 29.6967 13.2429 29.4467 13.402 29.1286C13.5649 28.8104 13.6463 28.4448 13.6463 28.032C13.6463 27.6191 13.5649 27.2554 13.402 26.9411C13.2429 26.6267 12.9948 26.3823 12.6577 26.2081C12.3243 26.0301 11.8944 25.9411 11.3679 25.9411H9.43608V35.8161H7.32812Z" fill="white"/>
<path d="M21.5682 35.8161H17.625V24.1797H21.6477C22.803 24.1797 23.7955 24.4126 24.625 24.8786C25.4583 25.3407 26.0985 26.0054 26.5455 26.8729C26.9924 27.7403 27.2159 28.7782 27.2159 29.9865C27.2159 31.1986 26.9905 32.2403 26.5398 33.1115C26.0928 33.9827 25.447 34.6513 24.6023 35.1172C23.7614 35.5831 22.75 35.8161 21.5682 35.8161ZM19.733 33.9922H21.4659C22.2765 33.9922 22.9527 33.8445 23.4943 33.549C24.036 33.2498 24.4432 32.8047 24.7159 32.2138C24.9886 31.6191 25.125 30.8767 25.125 29.9865C25.125 29.0964 24.9886 28.3577 24.7159 27.7706C24.4432 27.1797 24.0398 26.7384 23.5057 26.4467C22.9754 26.1513 22.3163 26.0036 21.5284 26.0036H19.733V33.9922Z" fill="white"/>
<path d="M29.2188 35.8161V24.1797H36.6733V25.9467H31.3267V29.1058H36.1619V30.8729H31.3267V35.8161H29.2188Z" fill="white"/>
</svg>
<span class="text-[#404164] leading-[100%] font-sf text-[12px] mt-4">Property Document</span>
</a>

             <a :href="propertyInfo.governmentID" class="bg-[#FAFAFA] p-4 w-fit rounded-[4px] mt-2 flex flex-col gap-2 items-center">
                        <svg width="44" height="48" viewBox="0 0 44 48" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M34 0L42 8V46C42 47.1046 41.1046 48 40 48H4C2.89543 48 2 47.1046 2 46V2C2 0.895431 2.89543 1.61064e-08 4 0H34Z" fill="#E4E7EC"/>
<path d="M42 8H34V0L42 8Z" fill="#98A2B3"/>
<rect y="20" width="44" height="20" rx="2" fill="#CC400C"/>
...
<span class="text-[#404164] leading-[100%] font-sf text-[12px] mt-4">Government ID</span>
</a>

       <a :href="propertyInfo.proofofOwnership" class="bg-[#FAFAFA] p-4 w-fit rounded-[4px] mt-2 flex flex-col gap-2 items-center">
                        <svg width="44" height="48" viewBox="0 0 44 48" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M34 0L42 8V46C42 47.1046 41.1046 48 40 48H4C2.89543 48 2 47.1046 2 46V2C2 0.895431 2.89543 1.61064e-08 4 0H34Z" fill="#E4E7EC"/>
<path d="M42 8H34V0L42 8Z" fill="#98A2B3"/>
<rect y="20" width="44" height="20" rx="2" fill="#CC400C"/>
...
<span class="text-[#404164] leading-[100%] font-sf text-[12px] mt-4">Proof of Ownership</span>
</a>
</div>
                    </div>
                  </a-tab-pane>
