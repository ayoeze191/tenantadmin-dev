<template>
  <div class="bg-neutral py-5 px-10 w-full overflow-y-scroll h-screen pb-40">
    <p class="text-txt_dark font-semibold text-2xl leading-7 uppercase mb-10">Register Admin User</p>
    
    <form class="auth_form bg-white rounded-xl" @submit.prevent="handleRegisterAdmin()">
        <!-- form block  -->
        <div class="w-full">
        ...
        <!-- form block  -->
            <div class="w-full">
                ...
                <input id="firstName" name="firstName" class="input mt-4 mb-10" v-model="first_name"  />
            </div>
        <!-- form block  -->
            <div class="w-full">
                ...
                <input id="lastName" name="lastName" class="input mt-4 mb-10" v-model="last_name"  />
            </div>
        </section>
        <!-- form block  -->
        ...
        <input id="password" name="password" class="input mt-4 mb-10" v-model="password"  />
...
export default {
    ...
    methods: {
        ...
        isDisabled(){
            if(!this.first_name || !this.last_name || !this.role || !this.password || !this.email){
                return true;
            }
            else return false;
        },
