<template>
    <div class="bg-neutral py-5 px-10 w-full overflow-y-scroll h-screen pb-40">
        <p class="text-txt_dark font-semibold text-2xl leading-7 uppercase mb-[29px]">Lease Management</p>
        <div class="flex justify-between w-full">
            <p class="mb-5 text-secondary font-medium text-lg leading-[25px] uppercase">Approval Requests (4)</p>
            <router-link to="/tenants/lease/pending">
                <p class="text-txt_dark flex gap-1 font-medium text-sm cursor-pointer">
                    See all 
                    <span class="my-auto">
                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 8.5026L4 8.5026M8.66667 5.16927L12 8.5026L8.66667 5.16927ZM12 8.5026L8.66667 11.8359L12 8.5026Z" stroke="#404164" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </span> 
                </p>
            </router-link>
        ...
        <ul class="flex w-full gap-3 largeTablet:flex-wrap">
            <li class="bg-white py-2.5 px-4 rounded-lg w-[350px] min-h-[108px] flex flex-col justify-between">
                <div class="flex justify-between">
                    <div>
                        <p class="font-medium text-txt_dark">B-29, Brina Apartments</p>
                        <p class="font-medium text-secondary text-xs leading-5 ">Tenant: Steph Orkuma, Derek Jones</p>
                    </div>
                    <p class="py-1 px-2.5 font-medium text-xs leading-3 text-scs bg-scs_bg h-5 my-auto rounded-2xl">Recieved</p>
                </div>
            ...
            <li class="bg-white py-2.5 px-4 rounded-lg w-[350px] min-h-[108px] flex flex-col justify-between">
                <div class="flex justify-between">
                    ...
                    <p class="py-1 px-2.5 font-medium text-xs leading-3 text-pnd bg-pending h-5 my-auto rounded-2xl">Sublease</p>
                </div>
                <a class="text-sm leading-6 text-txt_dark cursor-pointer underline" @click="openModal({})">View full details</a>
            </li>
            <li class="bg-white py-2.5 px-4 rounded-lg w-[350px] min-h-[108px] flex flex-col justify-between">
            ...
            <li class="my-auto cursor-pointer">
                <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M12.4219 10.7493L17.6752 16.0026L12.4219 21.2559L13.8352 22.6693L20.5019 16.0026L13.8352 9.33594L12.4219 10.7493Z" fill="#323232"/>
                    </g>
                    <defs>
          ...
          <ul>
              <li class="w-full rounded-md px-4 py-2 bg-grey mb-4">
                  <section class="flex w-full justify-between mb-4">
                    <p class="font-medium text-lg leading-6 text-txt_dark">Steph Orkuma <span class="text-secondary ml-1">Apt T-69, Sean Apartments </span> </p>

                    <div class="flex gap-2">
                        <p class="text-secondary font-semibold leading-7">Lease Expires:</p>
                        <div class="status_select bg-bg1">
                            <p class="text-txt_dark">21/12/21</p>
                        </div>
                    </div>
                  </section>
                  <a class="text-sm leading-6 text-txt_dark cursor-pointer underline" @click="openModal({})">View tenant information</a>
...
export default {
    ...
    methods: {
        ...
        handleFetchLeases(){
            ...
            FetchLeases(this.store.userProfile.adminUserID,query).then(response => {
