<template>
    <div class="bg-neutral py-5 px-10 w-full overflow-y-scroll h-screen pb-40">
      <ul class="tab">
        <li class="tab_item" :class="{selected_tab: selected_tab === 'tenants'}" @click="toggleTabs('tenants')">Tenant Overview</li>
        <li class="tab_item" :class="{selected_tab: selected_tab === 'lease'}" @click="toggleTabs('lease')">Lease Management</li>
      </ul>
      <section class="list_container mt-10">
          <div class=" flex w-full justify-between border-b border-br1 pb-3 mb-4">
              <p class="font-medium text-base text-secondary mr-0.5"> Total Number of Tenants:  <span class="text-primary font-semibold text-[18px]">(43)</span></p>
