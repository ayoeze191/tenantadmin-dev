<template>
  <a-layout-sider
    width="260"
    class="h-full min-h-screen overflow-y-auto bg-[#111921] flex flex-col justify-between"
  >
    <div class="">
      <div
    ...
    >
      <div class="flex gap-2">
        ...
        <div class="flex flex-col">
          <span
            class="text-[#000000] leading-[100%] font-medium text-[12px] mt-auto"
            >Paterson Paul</span
          >
          <span class="text-[#000000] leading-[100%] text-[10px] mt-[2px]"
            >Landlord</span
          >
        </div>
      </div>
      <div>
        <a-dropdown>
          <a
            ...
            style="background-image: var(#ffffff, #d9d9d9)"
            @click.prevent
          >
            <EllipsisOutlined class="text-black" />
          </a>
          <template #overlay>
            <a-menu>
              <a-menu-item>
                <button
                  @click="LogUserOut"
                  class="text-[#A00000] p-0 font-inter font-medium text-[12px] flex gap-[4px]"
                >
