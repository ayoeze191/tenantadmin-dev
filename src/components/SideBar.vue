<template>
  <a-layout-sider
    width="260"
    class="h-full min-h-screen overflow-y-auto bg-primary"
  >
    <div class="flex gap-2 justify-center items-center py-4 pb-6">
      <img class="w-12 mb-3.5" src="../assets/logo.svg" alt="logo" />
      <h1 class="text-lg font-semibold text-white">10Ants</h1>
    </div>
    <a-menu
